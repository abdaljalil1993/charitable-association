...
<div style="height: 45px;"></div>
 ...
 <div class="container">
      ...
      <h1 class="text-center" style="color: rgb(33,55,91);">orphans request</h1>
      <hr>
      <table id="xx" class="table" style="color: blue;font-weight: bold; " >
        ...
        <tbody>
          ...
          if(isset($_GET['id']))
          mysqli_query($conn,"delete from orphans where id='".$_GET['id']."' ");

          $res=mysqli_query($conn,"select * from orphans ");
...
<tr>
                ...
                <td>'.$row['phone'].'</td>
             <td>'.$row['address'].'</td>
               <td><img src="orphans/'.$row['vac'].'" width="50" height="50"></td>
                 <td><img src="orphans/'.$row['edu'].'" width="50" height="50"></td>
                   <td><img src="orphans/'.$row['death'].'" width="50" height="50"></td>
                     
 <td>'.$row['state'].'</td>
                       <td><a class="btn btn-danger" href="moc.php?id='.$row['id'].'"> delete</a></td>
