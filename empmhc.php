...
<div style="height: 45px;"></div>
 ...
 <div class="container">
      ...
      <h1 class="text-center" style="color: rgb(33,55,91);">health care request </h1>
      <hr>
      <table id="xx" class="table" style="color: blue;font-weight: bold; " >
        ...
        <tbody>
          ...
          if(isset($_GET['id']))
          mysqli_query($conn,"update healthcare set state=1 where id='".$_GET['id']."' ");
                 ...
                 <td><img src="healthcareimages/'.$row['ip'].'" width="50" height="50"></td>
                   <td><img src="healthcareimages/'.$row['fb'].'" width="50" height="50"></td>
                     <td><img src="healthcareimages/'.$row['fr'].'" width="50" height="50"></td>
                       ...
                       <td><a class="btn btn-primary" href="empmhc.php?id='.$row['id'].'"> accept</a></td>
