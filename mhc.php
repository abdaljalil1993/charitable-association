          ...
          <span style="color: purple;font-size: 25px;font-weight: bolder;font-family: cursive;">O</span></a>
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li><a href="service.php">Manage User</a></li>
					<li><a href="mhc.php">Manage Health Request </a></li>
					
					<li><a href="moc.php">Manage Orphans Request </a></li>
						<li><a href="mhuc.php">Manage HumanSupport Request </a></li>
...
<div style="height: 45px;"></div>
 ...
 <div class="container">
      ...
      <h1 class="text-center" style="color: rgb(33,55,91);">health car</h1>
      <hr>
      <table id="xx" class="table" style="color: blue;font-weight: bold; " >
        ...
        <tbody>
          ...
          if(isset($_GET['id']))
          mysqli_query($conn,"delete from healthcare where id='".$_GET['id']."' ");

          $res=mysqli_query($conn,"select * from healthcare ");
...
<tr>
                ...
                <td>'.$row['phone'].'</td>
             <td>'.$row['address'].'</td>
               <td><img src="healthcareimages/'.$row['mr'].'" width="50" height="50"></td>
                 <td><img src="healthcareimages/'.$row['ip'].'" width="50" height="50"></td>
                   <td><img src="healthcareimages/'.$row['fb'].'" width="50" height="50"></td>
                     <td><img src="healthcareimages/'.$row['fr'].'" width="50" height="50"></td>
  <td>'.$row['state'].'</td>
                       <td><a class="btn btn-danger" href="mhc.php?id='.$row['id'].'"> delete</a></td>
