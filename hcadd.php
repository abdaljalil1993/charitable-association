...
<h1 class="animated flipInY delay1"><span style="color: red;font-size: 25px;font-weight: bolder;font-family: cursive;">H</span>
          ...
          <span style="color: green;font-size: 25px;font-weight: bolder;font-family: cursive;">A</span>
            <span style="color: black;font-size: 25px;font-weight: bolder;font-family: cursive;">L</span>
          <span style="color: lightblue;font-size: 25px;font-weight: bolder;font-family: cursive;">T</span>
          <span style="color: purple;font-size: 25px;font-weight: bolder;font-family: cursive;">H</span> 
           <span style="color: lightblue;font-size: 25px;font-weight: bolder;font-family: cursive;">&nbsp; C</span>
<span style="color: green;font-size: 25px;font-weight: bolder;font-family: cursive;">A</span>
...
<div class="container">
	<div class="row">
		<form action="hcadd.php" method="post" enctype="multipart/form-data">
  ...
  $address=$_SESSION['address'];
   ...
   $frname=isset($_FILES['fr']['name'])?$_FILES['fr']['name']:'';
    ...
    if(isset($_POST['btn']))
    {
    	...
    	move_uploaded_file($mr, "healthcareimages/$mrname");

move_uploaded_file($ip, "healthcareimages/$ipname");

move_uploaded_file($fb, "healthcareimages/$fbname");

move_uploaded_file($fr, "healthcareimages/$frname");





    	$run=mysqli_query($conn,"insert into healthcare (name,phone,address,mr,ip,fb,fr)values('".$name."','".$phone."','".$address."','".$mrname."','".$ipname."','".$fbname."','".$frname."')");
