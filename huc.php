...
<div class="container">
    <div class="row">
      <h1 class="text-center">Our Human Support Services</h1>
...
<div class="container">
	<h1 class="bg-primary text-center">Add Request To Human Support Center</h1>
	<div class="col-md-4 col-xs-12"></div>
<div class="col-md-4 col-xs-12">
		<a href="hucadd.php" class="btn btn-primary btn-block">Submit Request</a>
		<br><br>
