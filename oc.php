...
<div class="container">
    <div class="row">
      <h1 class="text-center">Our Orphans Services</h1>
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/9.jfif" alt="" />
							</div><!--icon box top -->
							<h4>Salary</h4>
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/10.jfif" alt="" />
							</div><!--icon box top -->
							<h4>Food Basket</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/11.jfif" alt="" />
							</div><!--icon box top -->
							<h4>Education</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/12.jfif" alt="" />
							</div><!--icon box top -->
							<h4>Gifts</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
   ...
   <div class="row">
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/6.jfif" alt="" />
							</div><!--icon box top -->
							<h4>Medicene</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/4.jpg" alt="" />
							</div><!--icon box top -->
					...
					<div class="col-md-3">
						<div class="grey-box-icon">
							<div class="icon-box-top grey-box-icon-pos">
								<img class="img-circle" style="width: 150px;height: 150px;" src="assets/images/slides/13.jfif" alt="" />
							</div><!--icon box top -->
							<h4>University guarantee</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue
							eset nec lacus elit dor broma.</p>
...
<div class="container">
	<h1 class="bg-primary text-center">Add Request To Orphans Care Center</h1>
	<div class="col-md-4 col-xs-12"></div>
<div class="col-md-4 col-xs-12">
		<a href="ocadd.php" class="btn btn-primary btn-block">Submit Request</a>
		<br><br>
