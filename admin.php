...
<div class="animated fadeInLeft" style="width: 400px;height: 200px;border-radius: 20px;padding: 10px;
border:2px white solid;text-align: center;margin: 10px auto 200px auto;background-image: linear-gradient(#33278f,#aaeeff);color: white;">
  <h2>Admin DashBoard</h2>
  <hr>
  <h3>Manage Your Site Easly</h3>
</div>
